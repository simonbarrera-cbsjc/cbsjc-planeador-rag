  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-[#0E1B4D]">Historial de Documentos Generados</h1>
        ...
        <Link href="/generate">
          <Button className="bg-[#D71921] hover:bg-[#B81219] text-white font-bold flex items-center gap-2 rounded-xl shadow-md">
      ...
      <Card className="border-slate-200 shadow-sm overflow-hidden rounded-2xl bg-white">
        {loading ? (
              ...
              <tbody className="divide-y divide-slate-100">
                {filteredDocs.map((doc) => (
                  <tr key={doc.id} className="hover:bg-slate-50/80 transition-colors">
                    ...
                    <td className="p-3.5">
                      <Badge variant="default" className="text-[10px] font-bold bg-[#162874]">
                      ...
                      <div className="flex items-center justify-end gap-1.5">
                        <Link href={`/preview/${doc.id}`}>
                          <Button
                            size="sm"
                            variant="outline"
                            className="h-8 px-2.5 text-xs font-bold text-[#162874] border-[#162874]/20 hover:bg-[#162874] hover:text-white rounded-xl transition-colors"
                          >
          ...
          <div className="p-12 text-center space-y-3">
            ...
            <p className="text-sm font-bold text-slate-700">No se encontraron documentos</p>
            ...
            <Link href="/generate">
              <Button size="sm" className="bg-[#D71921] hover:bg-[#B81219] text-white font-bold rounded-xl mt-2">
