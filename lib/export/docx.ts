                ...
                children: [
                  new TableCell({
                    children: [
                      new Paragraph({
                        children: [
                          new TextRun({ text: 'Institución: ', bold: true, color: '003087' }),
                  ...
                  new TableCell({
                    children: [
                      new Paragraph({
                        children: [
                          new TextRun({ text: 'Fecha: ', bold: true, color: '003087' }),
                ...
                children: [
                  new TableCell({
                    children: [
                      new Paragraph({
                        children: [
                          new TextRun({ text: 'Área / Nivel: ', bold: true, color: '003087' }),
                  ...
                  new TableCell({
                    children: [
                      new Paragraph({
                        children: [
                          new TextRun({ text: 'Grado / Periodo: ', bold: true, color: '003087' }),
